package team.dovecotmc.tacticalcards.item;
...
public class GraphicCardItem extends BlockItem {
    ...
    protected void explode(Level level, Vec3 pos) {
        ...
        final boolean flag = net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(level, null) && CommonConfig.destroysTerrain.get();
